...
# module Genomics
#   module IO
#     describe BLATFormat do
#       
#       context "instance_methods" do
#         let(:blat_file_path) { File.join(SPEC_PATH, 'fixtures', 'io', 'blat_format.psl') }
#         
#         describe '#each' do
#           context 'for a psl file' do
#             let(:blat_format) { BLATFormat.open(blat_file_path) }
#             
#             it "should iterate through each of the hits" do
#               blat_format.each do |hit|
